...
#  n.b. 
#    with multiple cores / logical processors, you'll see an increase as you up the chunks (to your number of cores)
...
if __name__ == '__main__':
    ...
    #imports were put here because they were loading twice under Windows -- this is not an issue in Linux
    ...
    chunks=4 #how many chunks do we want; equals the number of processes
